...
public class WenSpikeShield : Tile
{
	...
	{
		if (isBeingHeld && collision.gameObject.GetComponent<Tile>().hasTag(TileTags.Enemy))
		{
			collision.gameObject.GetComponent<Tile>().takeDamage(collision.gameObject.GetComponent<Tile>(), 1);
		}
	}
